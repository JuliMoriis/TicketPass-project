...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, AddRecintoComponent, ListRecintoComponent, RecintoPageComponent, AddEventoComponent, EventoPageComponent, ListEventoComponent, UsuarioPageComponent],
